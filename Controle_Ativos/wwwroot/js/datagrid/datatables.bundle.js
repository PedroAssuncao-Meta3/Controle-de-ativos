! function (n) {
    ...
    function ye(t) {
        return t || (t = {}), t.filter && t.search === z && (t.search = t.filter), W.extend({
            search: "none",
            order: "current",
            page: "all"
        }, t)
    ...
    function (n) {
        ...
        language: {
            ...
            search: '<div class="input-group-text d-inline-flex width-3 align-items-center justify-content-center border-bottom-right-radius-0 border-top-right-radius-0 border-right-0"</div><i class="fa fa-search"> </i> ',
        ...
        return o.ext.buttons.copyHtml5 = {
            ...
            action: function (t, e, n, o) {
                ...
                var r = g(e, o).str,
                    ...
                    i = o.charset;
                o.customize && (r = o.customize(r, o, e)), !1 !== i ? (i || (i = m.characterSet || m.charset), i && (i = ";charset=" + i)) : i = "", o.bom && (r = "\ufeff" + r), R(new Blob([r], {
                    type: "text/csv" + i
